...
var approvedContextCallables = []callableApproval{
	...
	{file: "sessionstore/store.go", kind: "method", owner: "method *Store.Append", fingerprint: "func(ctx context.Context, ref github.com/plasmid-dev/plasmid/loop.SessionRef, event github.com/plasmid-dev/plasmid/loop.Event) error", count: 1, rationale: "legacy durable event append retained only until E03 native migration"},
	{file: "sessionstore/store.go", kind: "method", owner: "method *Store.Create", fingerprint: "func(ctx context.Context, r github.com/plasmid-dev/plasmid/loop.CreateSessionRequest) (github.com/plasmid-dev/plasmid/loop.SessionRef, error)", count: 1, rationale: "legacy session creation retained only until E03 native migration"},
	{file: "sessionstore/store.go", kind: "method", owner: "method *Store.Delete", fingerprint: "func(ctx context.Context, app string, user string, id string) error", count: 1, rationale: "legacy session deletion retained only until E03 native migration"},
	{file: "sessionstore/store.go", kind: "method", owner: "method *Store.Get", fingerprint: "func(ctx context.Context, app string, user string, id string) (github.com/plasmid-dev/plasmid/loop.SessionRef, []github.com/plasmid-dev/plasmid/loop.Event, error)", count: 1, rationale: "legacy session lookup retained only until E03 native migration"},
	{file: "sessionstore/store.go", kind: "method", owner: "method *Store.List", fingerprint: "func(ctx context.Context, app string, user string) ([]github.com/plasmid-dev/plasmid/loop.SessionRef, error)", count: 1, rationale: "legacy session listing retained only until E03 native migration"},
	...
	nestedCallableApproval("sessionstore/store.go", "variable _ in file scope via method Delete", "func(ctx context.Context, appName string, userID string, sessionID string) error", "legacy session-service conformance retained until E03"),
	nestedCallableApproval("sessionstore/store.go", "variable _ in file scope via method Get", "func(ctx context.Context, appName string, userID string, sessionID string) (github.com/plasmid-dev/plasmid/loop.SessionRef, []github.com/plasmid-dev/plasmid/loop.Event, error)", "legacy session-service conformance retained until E03"),
	nestedCallableApproval("sessionstore/store.go", "variable _ in file scope via method List", "func(ctx context.Context, appName string, userID string) ([]github.com/plasmid-dev/plasmid/loop.SessionRef, error)", "legacy session-service conformance retained until E03"),
	nestedCallableApproval("sessionstore/store.go", "variable _ in file scope via method LoadSidecar", "func(ctx context.Context, appName string, userID string, sessionID string, kind string, destination any) (bool, error)", "legacy session-service conformance retained until E03"),
