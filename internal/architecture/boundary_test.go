...
var approvedContextCallables = []callableApproval{
	...
	{file: "tool_guard.go", kind: "top-level function", owner: "func processGuardedToolRequest", fingerprint: "func(ctx google.golang.org/adk/v2/agent.Context, request *google.golang.org/adk/v2/model.LLMRequest, source google.golang.org/adk/v2/tool.Tool, wrapper google.golang.org/adk/v2/tool/toolutils.Tool, contexts *github.com/plasmid-dev/plasmid/contextresolver.Resolver, confirmation bool) error", count: 1, rationale: "single owner for native request packing and processor-selected delegate decoration"},
	{file: "tool_guard.go", kind: "top-level function", owner: "func toolPolicyError", fingerprint: "func(ctx google.golang.org/adk/v2/agent.Context, contexts *github.com/plasmid-dev/plasmid/contextresolver.Resolver, name string, args map[string]any) error", count: 1, rationale: "single owner for built-in and execution-time tool-policy checks"},
	...
	{file: "foreign/codex.go", kind: "top-level function", owner: "func ScanCodexWithActivations", fingerprint: "func(ctx context.Context, options Options, vault *github.com/plasmid-dev/plasmid/internal/foreignactivation.Vault) (HostCatalog, error)", count: 1, rationale: "bounded cancellation-aware foreign activation discovery"},
	...
	{file: "skills/toolset.go", kind: "method", owner: "method *Toolset.catalog", fingerprint: "func(ctx context.Context) (github.com/plasmid-dev/plasmid/extensions.Catalog, error)", count: 1, rationale: "native ADK skill toolset activation operation"},
	{file: "harness.go", kind: "method", owner: "method *Harness.ListTemplates", fingerprint: "func(ctx context.Context, sessionID string) ([]github.com/plasmid-dev/plasmid/extensions.Template, error)", count: 1, rationale: "Harness-owned native ADK session and template operation"},
	{file: "extensions/store.go", kind: "method", owner: "method *Store.ObserveTouch", fingerprint: "func(_ context.Context, touch github.com/plasmid-dev/plasmid/workspace.Touch)", count: 1, rationale: "bounded cancellation-aware extension snapshot operation"},
